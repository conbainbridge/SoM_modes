var jsPsychSurveyMultiChoiceC = (function (jspsych) {
  'use strict';
  ...
  class SurveyMultiChoicePlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.autocomplete) {
              html += '<div style="overflow-y:scroll; height:500px !important"><form id="jspsych-survey-multi-choice-form">';
          }
          else {
              html += '<div style="overflow-y:scroll; height:500px !important"><form id="jspsych-survey-multi-choice-form" autocomplete="off">';
          }
